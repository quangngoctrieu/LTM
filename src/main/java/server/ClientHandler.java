			...
			while (running) {
				...
				case EXIT:
					if (peerInfo == null) {
						...
						ClientHandler b;
						if (Server.listMatched.get(peerInfo) != null && Server.listMatched.get(peerInfo).getPeerInfo().equals(username)) {
				...
				case DISCONNECT:
					ClientHandler bx;
					if (Server.listMatched.get(peerInfo) != null
							&& Server.listMatched.get(peerInfo).getPeerInfo().equals(username)) {
						bx = Server.listMatched.get(peerInfo);
